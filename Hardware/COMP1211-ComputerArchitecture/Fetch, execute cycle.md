...
## Interrupts
- every cycle the CPU can receive an [[../../Operating Systems/Interrupts|Interrupt]] which will stop the CPU, run the process then the CPU can carry on afterwards
![[../../Operating Systems/Interrupts#Interrupt cycle]]
